...
class ActionStartup
{
     ...
     */
    private function rotationLogs(): void
    {
        ...
        Util::clearFolder($bearsamppRoot->getLogsPath(), ['archives', '.gitignore']);
    }

    /**
     * Cleans temporary folders by removing unnecessary files.
     */
    private function cleanTmpFolders(): void
    {
        ...
        Util::clearFolder($bearsamppRoot->getTmpPath(), ['cachegrind', 'composer', 'openssl', 'mailhog', 'mailpit', 'xlight', 'npm-cache', 'pip', 'yarn', '.gitignore']);
     ...
     */
    private function cleanOldBehaviors(): void
    {
     ...
     */
    private function killOldInstances(): void
    {
     ...
     */
    private function refreshHostname(): void
    {
     ...
     */
    private function checkLaunchStartup(): void
    {
     ...
     */
    private function sysInfos(): void
    {
        global $bearsamppLang;
     ...
     */
    private function refreshVhosts(): void
    {
        global $bearsamppConfig, $bearsamppLang, $bearsamppBins;
     ...
     */
    private function scanFolders(): void
    {
        global $bearsamppLang;
    ...
    private function changePath(): void
    {
        ...
        $this->writeLog('Nb occurrences changed: ' . $result['countChangedOcc']);
    }
     ...
     */
    private function checkPathRegKey(): void
    {
     ...
     */
    private function checkBinsRegKey(): void
    {
        global $bearsamppLang, $bearsamppRegistry;
     ...
     */
    private function checkSystemPathRegKey(): void
    {
        global $bearsamppLang, $bearsamppRegistry;
     ...
     */
    private function createSslCrts(): void
    {
     ...
     */
    private function refreshGitRepos(): void
    {
